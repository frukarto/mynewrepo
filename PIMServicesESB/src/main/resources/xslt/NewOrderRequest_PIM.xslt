<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:core="http://www.hns.com/iag/schemas/core" xmlns:n1="http://www.hns.com/iag/schemas/partner" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://soap.sforce.com/schemas/class/PartnersOrder" xmlns:fn="http://www.w3.org/2005/02/xpath-functions" exclude-result-prefixes="core n1 xs fn">
		<xsl:output method="xml" encoding="UTF-8" indent="yes"/>
		<xsl:template match="n1:NewOrderRequest">
			<tns:NewOrderRequest>
				<tns:req>
					...
					<xsl:for-each select="n1:FraudAlertOverrideFlag">
						<tns:FraudAlertOverrideFlag>
							<xsl:value-of select="."/>
						</tns:FraudAlertOverrideFlag>
					</xsl:for-each>
					...
					<xsl:for-each select="n1:PartnerType">
						<tns:PartnerType>
							<xsl:value-of select="."/>
						</tns:PartnerType>
					</xsl:for-each>
